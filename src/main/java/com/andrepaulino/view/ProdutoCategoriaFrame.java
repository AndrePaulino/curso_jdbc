...
import com.andrepaulino.controller.CategoriaController;
import com.andrepaulino.controller.ProdutoController;
...
public class ProdutoCategoriaFrame extends JFrame {
	...
	private final JLabel labelNome, labelDescricao, labelCategoria;
	private final JTextField textoNome, textoDescricao;
	private final JComboBox<Categoria> comboCategoria;
	private final JButton botaoSalvar, botaoEditar, botaoLimpar, botarApagar;
	...
	public ProdutoCategoriaFrame() {
		...
		botaoLimpar.addActionListener((ActionEvent e) -> limpar());

		botarApagar.addActionListener((ActionEvent e) -> {
			deletar();
			limparTabela();
			preencherTabela();
		});
